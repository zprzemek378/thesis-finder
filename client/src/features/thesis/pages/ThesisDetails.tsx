          ...
          <div className="md:col-span-2">
            <div className="bg-white rounded-lg shadow-md p-6">
              <div className="flex justify-between items-start mb-4">
                <h1 className="text-2xl font-bold text-[var(--o-blue)]">{exampleThesis.title}</h1>
              ...
              <AspectRatio.Root ratio={16/9} className="mb-8">
                <div className="h-full overflow-auto">
                  <p className="text-gray-800 whitespace-pre-line">{exampleThesis.description}</p>
                </div>
              </AspectRatio.Root>
              ...
              <div className="flex space-x-4">
                ...
                <Button variant="outline" className="border-[var(--o-blue)] text-[var(--o-blue)]">
                  Wyślij wiadomość
                </Button>
              </div>
            </div>
